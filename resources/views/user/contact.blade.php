...
<link rel="stylesheet" type="text/css" href="{{asset('css/styles/contact_styles.css')}}">
	...
	<img width="125px" style="top:0;" height="100%" src="images/logo1.jpeg" alt="">
						...
						<!-- Main Navigation -->
							...
							<ul class="main_nav_list">
								<li class="main_nav_item "><a href="{{URL('/')}}">الصفحة الرئيسية</a>
								</li>
								<li class="main_nav_item"><a href="about.html">عنا</a></li>
								
								<li class="main_nav_item active"><a href="{{URL('contact')}}">تواصل معنا</a></li>
							</ul>
						</nav>
				...
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">تواصل </div>
							<div class="home_breadcrumbs">
								<ul class="home_breadcrumbs_list">
									<li class="home_breadcrumb"><a href="{{URL('/')}}">الصفحه الرئيسيه</a></li>
									<li class="home_breadcrumb">تواصل</li>
								</ul>
							</div>
						</div>
					</div>
...
<script src="{{asset('js/js/contact_custom.js')}}"></script>
</body>
</html>